...
## Settings Service / Validation Service

- [x] Settings Repository
- [x] Settings Service Class
- [x] Settings Validation Service Class
- [x] field validators
- [x] Settings Meta dc
- [x] Remove direct connections to UI

## Controller Infrastructure

- [ ] separate logic from forms/pages into controllers
- [x] introduce controller factory (used only in composition layer)
- [/] create page-specific controller containers (LessonPageControllers, etc.)
- [x] inject controllers into pages at creation (no runtime lookup)
- [ ] pipelines emit domain events (rename UIEvent → Event)
- [ ] controllers translate pipeline events → UI updates
- [x] define UI composition layer (MainScreen/CentralWidget) for wiring
- [/] controllers translate validation events -> UI updates
...
- [x] Move Core Methods to Base class

### Transformers & Processors

- [x] Restructure Processor folder root -> provider -> domain
- [ ] Transformers Global Registry Class
- [ ] Processors Global Registry Class
- [x] Provider Registry Class
  - [x] Transformer
  - [x] Processor
- [x] Domain Registry Class (e.g. Lessons, Words etc)
  - [x] Base Class - Transformer
  - [x] Base Class - Processor
- [x] Section Transformers
- [x] Section Processors

## CPOD Scrape Refactor

- [ ] move cpod from core to services
  - [ ] Words
  - [x] Lessons
- [ ] Create tasks for steps handled in CPOD Scrape in Pipeline
  - [ ] Words
  - [x] Lessons
- [ ] refactor scraper to just handle network calls and return payloads
  - [ ] Words
  - [x] Lessons
- [ ] Move out transformation handling to pipeline
  - [ ] Words
  - [x] Lessons
...
- [ ] Move enums for domain to domain folder
- [ ] Move models for domain to domain folder
...
## CPOD Lesson Scrape Refactor

- [x] Move cpod from core → services
- [x] Move parse\_\* → transformers/cpod/lesson/
- [x] Define LESSONTASK flow for scraping in pipeline
- [x] Remove task flow logic from scraper
- [x] Remove lesson lifecycle handling from scraper
- [x] Refactor scraper → CPodLessonService
  - [x] Only handle network calls + emit raw payload
- [x] Apply transformers in pipeline
- [x] Pass to processor
- [x] Dispatch next tasks from pipeline

## CPOD Lesson Fallback

- [x] migrate old LessonScraperV1 selenium scraping to playwright
- [x] implement transformers for each section
- [x] implement fallback processes in CPOD Pipeline on API failure
