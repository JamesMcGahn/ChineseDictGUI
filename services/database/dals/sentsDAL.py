...
class SentsDAL(BaseDAL[Sentence]):
    ...
    def exists(
        ...
        tuple[int, str, str, str, str, str, str, int, int, int, str, str, str, str, str]
    ]:
    ...
    def insert_one(self, item: Sentence) -> int:
    ...
    def delete_many_by_id(self, ids) -> tuple[
        int,
        tuple[
            int, str, str, str, str, str, str, int, int, int, str, str, str, str, str
        ],
    ]:
